    ...
    <div class="thumbnail">
        <img src="{$stdProduct->prod_image}" alt=""> <!--http://placehold.it/800x500"-->
                    <div class="caption">
                        ...
                        <p>
                            <a href="/resources/backend/controllers/proxyCartController.php?add={$stdProduct->prod_id}" class="btn btn-primary">Add to Cart</a> <a href="item.php?prod_id={$stdProduct->prod_id}" class="btn btn-default">More Info</a>
                        </p>
                    </div>
    </div>
</div>
